...
namespace SalonHub.Application.Services
{
    public class MonthlyTopPerformerJob
    {
        ...
        public async Task SelectMonthlyWinners()
        {
            ...
            // MÜVƏQQƏTİ (TEST): tarix filtri söndürülüb, bütün-zaman rəylərinə görə seçir.
            // Production-a qaytarmaq üçün aşağıdakı sətri əvvəlki tarix-filtrli versiya ilə əvəz et.
