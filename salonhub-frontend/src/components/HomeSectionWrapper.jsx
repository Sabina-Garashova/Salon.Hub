...
export default function HomeSectionWrapper({
  ...
  return (
    <section id={id} className="relative w-full max-w-7xl mx-auto my-6 md:my-8 rounded-3xl bg-gradient-to-br from-[#E3CC9E]/90 to-[#C9AD70]/85 backdrop-blur-lg border border-[#B8935A]/40 shadow-md pt-4 pb-10 md:pb-14 overflow-hidden">
